...
Table:  Description of study sites. Site in the data source column refer to Table @tbl:TableS3. {#tbl:TableS1 tag="S1"}
...
Table: Cross-match between the number of indicator species selected by TITAN as win-win vs. trade-off and expert-based classification into forest and non-forest species. {#tbl:TableS10 tag="S10" width=4}
